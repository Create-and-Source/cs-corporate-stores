...
const SUGGESTIONS: Suggestion[] = [
  { query: "hoodie for my team", category: "Hoodies & Sweats", icon: "🧥" },
  { query: "polo for our sales team", category: "Polos", icon: "👔" },
  { query: "hat with our logo", category: "Headwear", icon: "🧢" },
  { query: "coffee mug for the office", category: "Drinkware", icon: "☕" },
  { query: "t-shirt for an event", category: "T-Shirts & Tops", icon: "👕" },
  { query: "jacket for the team", category: "Outerwear", icon: "🧥" },
  { query: "backpack or tote bag", category: "Bags", icon: "🎒" },
  { query: "quarter zip pullover", category: "Quarter Zips", icon: "🧥" },
  { query: "water bottle or tumbler", category: "Drinkware", icon: "🥤" },
  { query: "notebook or office supplies", category: "Office", icon: "📓" },
  { query: "new hire welcome kit", category: "T-Shirts & Tops", icon: "🎁" },
  { query: "holiday gifts for employees", category: "Hoodies & Sweats", icon: "🎄" },
  { query: "something premium for executives", category: "Outerwear", icon: "✨" },
  { query: "beanie for winter", category: "Headwear", icon: "🧣" },
  { query: "phone case or tech accessories", category: "Tech", icon: "📱" },
];
